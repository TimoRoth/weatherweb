...
function create_summary_chart(div_id, data_url, wind_speed_id, wind_dir_id, temp_id, humid_id, rain_id, bila_id) {
    ...
    var bila_color = "#FF7F00";
    var bila_name = "Strahlungsbilanz - W/m²";
    ...
    chart.addAxis({title: {text: bila_name, style: {"color": bila_color}}, id: "bila_axis", gridLineWidth: 0, opposite: true}, false);
    ...
    var bila_series = chart.addSeries({name: bila_name, yAxis: "bila_axis", color: bila_color}, false);
